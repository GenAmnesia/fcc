...
suite("Unit Tests", function () {
  ...
  suite("Equality", function () {
    ...
    test("#equal, #notEqual", function () {
      ...
      assert.notEqual({ value: 1 }, { value: 1 }, "== compares object references"); // prettier-ignore
      assert.equal(6 * "2", "12");
  ...
  suite("Arrays", function () {
    ...
    test("Array #include, #notInclude", function () {
      ...
      assert.include(backendLanguages, "javascript", "JS is a backend language"); //prettier-ignore
    });
  });
